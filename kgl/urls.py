...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='digitalbook/login.html'), name = 'login'),
    path('logout/', auth_views.LoginView.as_view(template_name='digitalbook/logout.html'), name = 'logout'),
